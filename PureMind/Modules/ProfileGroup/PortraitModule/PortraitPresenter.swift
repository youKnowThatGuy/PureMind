...
class PortraitPresenter: PortraitPresenterProtocol{
    ...
    var tests = ["Эмоциональное выгорание", "Тревожность", "Идентичность", "Негативные установки", "Шкала базисных убеждений", "Профиль отношений", "Переживание перемен", "Самооценка", "ellis", "yanoff", "prt", "ruvs", "amirkhan", "epqRS", "itt", "bienetre", "maslach"]
