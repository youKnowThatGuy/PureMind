...
class PortraitPresenter: PortraitPresenterProtocol{
    ...
    var tests = ["Диагностика иррациональных установок, SPB", "Шкала базисных убеждений, WAS (Янов-Бульман)", "Тест профиля отношений, RPT (Борнстейн)", "Тест уверенности в себе (Ромек)", "Индикатор копинг-стратегий, CSI (Амирхан)", "Личностный опросник Айзенка, EPQ-RS", "Интегративный тест тревожности, ИТТ", "Шкала субъективного благополучия", "Опросник профессионального выгорания Маслач, MBI/ПВ", "Эмоциональное выгорание", "Тревожность", "Идентичность", "Негативные установки", "Шкала базисных убеждений", "Профиль отношений", "Переживание перемен", "Самооценка"]
